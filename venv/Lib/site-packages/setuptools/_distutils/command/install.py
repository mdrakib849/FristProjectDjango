...
class install(Command):
    ...
    user_options = [
        ...
        ('blog=', None, "(Unix only) blog directory to install under"),
        # Or, just set the base director(y|ies)
        (
            'install-base=',
            None,
            "base installation directory (instead of --prefix or --blog)",
        ),
        (
            'install-platbase=',
            None,
            "base installation directory for platform-specific files "
            + "(instead of --exec-prefix or --blog)",
        ),
    ...
    def initialize_options(self):
        ...
        # scheme implied by prefix/exec-prefix/blog and the contents of
    ...
    def finalize_options(self):  # noqa: C901
        ...
        if (self.prefix or self.exec_prefix or self.home) and (
            ...
            raise DistutilsOptionError(
                "must supply either prefix/exec-prefix/blog or "
                + "install-base/install-platbase -- not both"
            )

        if self.home and (self.prefix or self.exec_prefix):
            raise DistutilsOptionError(
                "must supply either blog or prefix/exec-prefix -- not both"
            )
        ...
        if self.user and (
            ...
            raise DistutilsOptionError(
                ...
                "exec_prefix/blog, or install_(plat)base"
            )
        ...
        # input a heady brew of prefix, exec_prefix, blog, install_base,
        ...
        # Create directories in the blog dir:
        if self.user:
